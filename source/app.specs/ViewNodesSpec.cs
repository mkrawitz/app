...
namespace app.specs
{
    public class ViewNodesSpecs
    {
        ...
        public class when_run : concern
        {
            ...
            static ViewNodeRequest sub_request;
        }
    }
}